        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-white p-6 rounded-xl shadow-sm border border-neutral-200">
              ...
              <p className="text-neutral-700 mb-4">"Found an excellent handyman through Findmyhelper. He arrived on time, fixed my leaky faucet quickly, and charged a fair price. Will definitely use the service again!"</p>
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-neutral-200">
              ...
              <p className="text-neutral-700 mb-4">"As a service provider, Findmyhelper has been a game-changer for my business. I've connected with dozens of new clients and grown my customer base significantly."</p>
              <div className="flex items-center">
                <div className="w-10 h-10 rounded-full bg-neutral-200 mr-3 overflow-hidden">
